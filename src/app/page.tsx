...
export default function Home() {
  return (
    <main
      id="main-content"
      className="relative min-h-screen flex flex-col items-center justify-center py-12 md:py-16 overflow-hidden"
    >
      ...
      {/* Footer */}
      <footer className="relative z-10 mt-auto pt-8 pb-6 text-center space-y-1">
